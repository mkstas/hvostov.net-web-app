...
export const UpdateSubjectForm: FC<Props> = ({ closeModal, subject }) => {
  ...
  const [updateSubject, { isSuccess: isSuccessUpdate }] = useUpdateSubjectMutation();
  const [deleteSubject, { isSuccess: isSuccessDelete }] = useDeleteSubjectMutation();
  ...
  }, [isSuccessUpdate, isSuccessDelete, subject.title, deleteFilterParam, closeModal]);
